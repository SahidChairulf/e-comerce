<template>
  <hr class="w-screen h-1 mx-auto my-4 lg:my-6 md:my-6 bg-gray-900 lg:mt-40 border-0 rounded dark:bg-gray-700 hidden md:block lg:block">
  <!-- ====== Footer Section Start -->
  <footer class="px-3 pt-4 hidden lg:block md:block lg:px-9 md:px-6 bg-white">
